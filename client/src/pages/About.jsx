        ...
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-base text-gray-600 leading-relaxed mb-8">
              ...
              vừa <em>bền vững</em> — không cần phải chọn một trong hai. Digital
              Transformation ra đời để hiện thực hóa điều đó.
            </p>
            <a
              href="/lien-he"
        ...
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map(({ value, label }) => (
            <div key={label} className="text-center">
              <p className="font-[family-name:var(--font-display)] text-4xl font-extrabold text-green-600 mb-1">
                {value}
              </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 max-w-lg mx-auto">
              Ba trụ cột định hướng mọi hoạt động của chúng tôi.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {pillars.map(({ icon, title, desc }) => (
              <div
                key={title}
                className="flex flex-col items-center text-center gap-4 p-8 rounded-2xl bg-white shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-t-4 border-transparent hover:border-green-500"
              >
                <div className="w-14 h-14 flex items-center justify-center rounded-2xl bg-green-50 text-3xl shadow-sm">
                  {icon}
                </div>
