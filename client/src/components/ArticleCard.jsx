    ...
    <Link to={`/bai-viet/${article.id}`}
      ...
      <div className="relative h-[440px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-7 flex flex-col gap-2.5">
          <span className={`self-start px-2.5 py-0.5 rounded-full text-[11px] font-bold uppercase tracking-wider ${badge}`}>
          ...
          <p className="text-white/75 text-sm leading-relaxed line-clamp-2">{article.excerpt}</p>
